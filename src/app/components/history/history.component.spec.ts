...
describe('HistoryComponent', () => {
  ...
  beforeEach(() => {
    ...
    Savings = [
      ...
      { id: 5, name: 'cash', sum: 500, users_id: 3, createdAt: new Date('09.08.2022, 15:49') },
      { id: 6, name: 'bank', sum: 500, users_id: 3, createdAt: new Date('09.08.2022, 15:49') }
    ];

    fixture.detectChanges();
    mockLogSaving = { id: 1, name: 'cash', sum: 500, users_id: 1, createdAt: new Date('09.08.2022, 15:49') };
